 ...
 */
 ...
 add_filter( 'sbsa_register_settings_' . Admin_Controller::SETTING_SLUG, 'sbsa_tabbed_settings' );
				...
				array(
					...
					'show_if'  => array(
						...
						array(
							...
							array(
								'field' => 'license_section_4_complex-group-1',
								'value' => array( 'option-1', 'option-2' ),
							),
							// AND Control 2 is True.
							array(
								'field' => 'license_section_4_complex-group-2',
								'value' => array( '1' ),
							),
						),
						// OR show if Control 3 is True.
						array(
							'field' => 'license_section_4_complex-group-3',
							'value' => array( '1' ),
						),
					),
				),
