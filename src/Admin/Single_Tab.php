...
class Single_Tab {
	...
	public function wta_inclusion_categories_selector( $post_id, $times_svg_icon ) {
		...
		<div class="swtcategories-selector swtinclusion-selector">
			<div class="swtcomponent-search-field">
				<input data-type="category" type="text" data-taxonomy="categories" id="swtcategory-search" class="swtcomponent-search-field-control" placeholder="<?php _e( 'Search for categories', 'simple-product-tabs' ); ?>">
			</div>
	...
	<div class="swtcomponent-search-field disabled">
			<input disabled type="text" class="swtcomponent-search-field-control" placeholder="<?php _e( 'Search for products', 'simple-product-tabs' ); ?>">
	...
	<div class="swtcomponent-search-field disabled">
			<input disabled type="text" class="swtcomponent-search-field-control" placeholder="<?php _e( 'Search for tags', 'simple-product-tabs' ); ?>">
	  <a class="pro-version-link" target="_blank" href="https://solution-box.com/wordpress-plugins/simple-product-tabs/?utm_source=settings&utm_medium=settings&utm_campaign=settingsinline&amp;utm_content=swtsettings">
		<?php _e( 'Pro version only', 'simple-product-tabs' ); ?>
	  </a>
	</div>
	...
	public function save_visibility_condition( $post_id ) {
		...
		update_post_meta( $post_id, '_sptb_option_use_default_for_all', 'no' );
					...
					<tr>
						...
						<td>
							<fieldset>
								...
								<label>
									<input type="radio" id="_sptb_display_tab_globally" name="_sptb_display_tab_globally" class="swtvisibility_condition" checked="checked" value="yes" <?php checked( 'yes', $is_tab_global, true ); ?>>
										<?php _e( 'Display globally on all products', 'simple-product-tabs' ); ?>
								</label><br>
								<label>
									<input type="radio" id="_sptb_display_tab_globally" name="_sptb_display_tab_globally" class="swtvisibility_condition" value="no" <?php checked( 'no', $is_tab_global, true ); ?>>
