...
final class Util {
	...
	public static function get_option( $key ) {
		...
		$plugin_options = wp_parse_args( (array) get_option( 'wpt_options' ), array( 'description', 'hide_description', 'info', 'hide_info', 'review', 'hide_review', 'search_by_tabs', 'enable_accordion', 'accordion_shown_size', 'description_priority', 'info_priority', 'review_priority', 'license' ) );
